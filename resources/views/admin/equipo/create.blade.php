...
@section('content')
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="btn-group">
          <a href="{{ url('equipo') }}" class="btn blue darken-4 text-white"><i class="fas fa-sort-alpha-down-alt"></i> Listado</a>         
          <a href="{{ url('equipo/create') }}" class="btn blue darken-4 text-white"><i class="fa fa-plus-square"></i> Ingresar</a>
        </div>
      </div>
    </div>
    <br>
      ...
      <div class="col-md-12">
        <div class="card">
         <div class="card-header  outline-primary blue-gradient-dark text-white">
           ...
           {!!Form::open (['route'=>'equipo.store','id'=>'postulados_form'])!!}
            <div class="card-body">
              <ul class="list-inline">
                   ...
                   <li class="list-inline-item">
                      <a href="/equipo" class="link_ruta">
                        Listado &nbsp; &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i>
                      </a>
                    </li>
                   <li class="list-inline-item">
                      <a href="/equipo/create" class="link_ruta">
                        Nuevo
                      </a>
                    </li>
                  </ul><br>
                @include('admin.equipo.partials.nuevo')
            </div>
